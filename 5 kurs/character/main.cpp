...
int main()
{
    Function<uint8_t, uint8_t> fx1(8, 8, pi1);
    fx1.setData();
    printf("-----Streebog-----\n");
    printf("p(pi)*2^8 =     %.1f", fx1.p_f * (1 << 8));
    printf("\ndelta(pi)*2^8 = %.1f", fx1.delta_f * (1 << 8));
    printf("\nlambda(pi) = %d\n", fx1.lambda);

    Function<uint8_t, uint8_t> fx2(8, 8, pi2);
    fx2.setData();
    printf("\n-----Kuznhechik-----\n");
    printf("p(pi)*2^8 =     %.1f", fx2.p_f * (1 << 8));
    printf("\ndelta(pi)*2^8 = %.1f", fx2.delta_f * (1 << 8));
    printf("\nlambda(pi) = %d\n", fx2.lambda);

    Function<uint8_t, uint8_t> fx3(8, 8, pi3);
    fx3.setData();
    printf("\n-----AES-----\n");
    printf("p(pi)*2^8 =     %.1f", fx3.p_f * (1 << 8));
    printf("\ndelta(pi)*2^8 = %.1f", fx3.delta_f * (1 << 8));
    printf("\nlambda(pi) = %d\n", fx3.lambda);
}